...
const CreateEmploye = () => {
  ...
  const submitHandler = async (e) => {
    ...
    formData.append("courses", JSON.stringify(userDetails.course)); // Assuming courses is an array
    formData.append("imgUpload", userDetails.imgUpload); // Include imgUpload
  ...
  const changeHandler = (e) => {
    ...
    if (type === "file") {
      ...
      if (!isValidPhoneNumber(value)) {
        ...
        // Optional: Add more user feedback for invalid number here
      } else {
